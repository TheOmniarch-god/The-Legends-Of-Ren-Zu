...
function realmTokenEmailHtml({ tierName, code, appUrl }) {
  const logoUrl = `${String(appUrl || "").replace(/\/$/, "")}/assets/email-omniarch-logo.jpg`;
  return `
    <div style="margin:0;padding:0;background:#050403;font-family:Georgia,'Times New Roman',serif;color:#f7ead0;">
      <div style="max-width:620px;margin:0 auto;padding:30px 16px;">
        <div style="
          ...
          overflow:hidden;
          background:
            radial-gradient(circle at 50% 0%, rgba(255,220,150,0.18), transparent 36%),
            linear-gradient(180deg, #17100a 0%, #080604 100%);
          box-shadow:0 18px 60px rgba(0,0,0,0.58);
        ">
          <div style="padding:0;background:#050403;text-align:center;border-bottom:1px solid rgba(255,220,150,0.18);">
            <img src="${logoUrl}" alt="The Omniarch" width="620" style="display:block;width:100%;max-width:620px;height:auto;border:0;line-height:0;" />
          </div>

          <div style="padding:26px 28px 16px;border-bottom:1px solid rgba(255,255,255,0.08);">
            ...
            <div style="font-size:13px;line-height:1.6;color:rgba(247,234,208,0.60);margin-top:10px;">
              A sacred code has been prepared for your ascension.
            </div>
          </div>
          ...
          <div style="padding:26px 28px 30px;">
            ...
            <div style="
              ...
              border-radius:22px;
              padding:1px;
              background:linear-gradient(135deg, rgba(255,236,180,0.70), rgba(216,163,77,0.28), rgba(255,236,180,0.54));
            ">
              <div style="
                text-align:center;
                border-radius:21px;
                background:
                  radial-gradient(circle at 50% 0%, rgba(255,220,150,0.18), transparent 42%),
                  #100b07;
                padding:20px 16px 18px;
              ">
                <div style="font-size:10px;letter-spacing:0.24em;text-transform:uppercase;color:rgba(255,230,180,0.52);margin-bottom:10px;">
                  Sacred Code
                </div>
                <div style="
                  font-size:26px;
                  ...
                  text-shadow:0 0 18px rgba(255,220,150,0.30);
                ">
                  ${code}
                </div>
              </div>
            ...
            <p style="font-size:13px;line-height:1.65;color:rgba(247,234,208,0.66);margin:0 0 22px;">
              Login to The Legends of Ren Zu, open Treasure Yellow Heaven, then redeem this token under <strong>Realm Token</strong>.
            </p>
