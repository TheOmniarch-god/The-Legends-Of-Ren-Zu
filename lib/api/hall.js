...
export default async function handler(req, res) {
  ...
  if (req.method === "POST") {
    try {
      ...
      const finalCodexCount = isFounder && finalTotalGu > 0 ? finalTotalGu : codexCount;
      const isMyriad = isFounder || (finalTotalGu > 0 && finalCodexCount >= finalTotalGu);
      ...
      const payload = {
        ...
        codex_count: finalCodexCount,
        total_gu: finalTotalGu,
        is_myriad: isMyriad,
