...
import { Button } from "@renzu-bts/ui/components/button";
import { Input } from "@renzu-bts/ui/components/input";
import { Textarea } from "@renzu-bts/ui/components/textarea";
import { cn } from "@renzu-bts/ui/lib/utils";
import { cva, type VariantProps } from "class-variance-authority";
import type * as React from "react";

function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
	return (
		// biome-ignore lint/a11y/useSemanticElements: div with role="group" is the correct shadcn grouping pattern
		<div
...
function InputGroupAddon({
	...
	return (
		// biome-ignore lint/a11y/useSemanticElements: div with role="group" is the correct shadcn addon pattern
		// biome-ignore lint/a11y/useKeyWithClickEvents: click only forwards focus to the input; keyboard users tab to it directly
		<div
			role="group"
